...
object SettingsRegistry {
    ...
    interface ITypeInfo {
        ...
        val convertToExternalType: ((configValue: Any) -> Any)?
        val convertToInternalType: ((externalValue: Any) -> Any)?
    }
    ...
    data class TypeInfo(
        ...
        override val convertToExternalType: ((configValue: Any) -> Any)? = null,
        override val convertToInternalType: ((externalValue: Any) -> Any)? = null,
    ) : ITypeInfo
