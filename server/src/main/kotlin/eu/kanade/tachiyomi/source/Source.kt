...
interface Source {
    ...
    /**
     * Compatibility wrapper for host code that still performs the two update
     * operations independently. Extension API 1.6 implementations only need
     * to implement [getMangaUpdate].
     */
